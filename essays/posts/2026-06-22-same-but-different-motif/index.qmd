...
subtitle: >-
  ...
  different clothes, in a domain you were not modelling. This is a heuristic for
  the modeller — not evidence about the world.
description: >-
...
Finding a motif is **abductive**, not demonstrative. It shifts the modeller's prior; it does not settle anything about the world. Recognizing that your phase generator's signature also appears, transformed, in an unrelated system is *subjective evidence that you are on the right track* — a private confidence update, the kind that tells you which thread to pull next. It is not statistical proof, not a footprint of a discrete universe, not a validation of an ontology. The motif licenses **more investigation**, and only investigation — derivation, prediction, test — can ever do the validating. Treating the recognition itself as the verdict is precisely the error that gives cross-scale pattern-matching its bad name.

This essay is therefore about the *epistemics of the modeller*, not the structure of reality. It belongs to the same lane as the program's [Statement of Intent](../../../index.qmd): a claim about what we can *do* — recognize a promising rule — not a claim about what the universe *is*.
...
- In **machine learning**, the same circuit motif recurring across unrelated tasks and architectures is a cue that you have found a real computational primitive rather than a dataset artefact.
...
1.  A "same but different" motif appearing in a domain you were not modelling is subjective evidence that the generating rule you guessed may be the right one — a confidence update for the modeller, nothing more.
...
- [Statement of Intent](../../../index.qmd) — the capability-not-ontology framing this essay applies to the modeller's own reasoning.
