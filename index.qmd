...
::: {.callout-note title="On falsifiability" appearance="default"}
A framework worth taking seriously must be able to be wrong — so this program
treats falsifiability as something to *earn and search for*, not to assume. The
claims that could currently kill the framework, calibrated against existing
physics, are collected in the [claim map's standing falsifiable
predictions](papers/claim-map.qmd#standing-falsifiable-predictions) — the one
place the program commits to falsifiable claims. Predicting genuinely *new*
physics, rather than recovering known physics, is a further ambition gated on the
forthcoming mathematics papers and the A=1 nuclear-chemistry work — and is not
claimed until it arrives. Elsewhere, the program asserts mathematical capability,
not measured confirmation.
:::
